...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ size = 'md', error, leftIcon, rightIcon, label, helperText, errorText, className = '', id, ...props }, ref) => {
    ...
    const baseStyles = 'rounded-lg border bg-white transition-all duration-200 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-offset-0';
